                    ...
                    <tbody>
                        ...
                        if ($result) {
                            ...
                            while ($rows = $result->fetch_assoc()) {
                                ...
                                echo '<td> <button id="' . $rows['proposalid'] . '" class="edits btn btn-sm btn-primary">Edit</button> <button id="d' . $rows['proposalid'] . '" class="deletes btn btn-sm btn-danger">Delete</button> </td>
                                  </tr>';
                            }
                        }
                        ?>
